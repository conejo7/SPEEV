 ...
 * La sincronizacion utiliza dos listados. Uno que representa a los objetos que
 * se encuentran en la BD y otro que representa a los objetos de sincronizacion.
 *
 * @param <T> Clase correspondiente al modelo  que especifica
...
public class ListOperationsDB<T, ID extends Serializable> {
     ...
     * @return numero de registros que se creo, actualizo y elimino
     */
